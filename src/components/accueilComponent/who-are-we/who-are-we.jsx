...
class WhoAreWe extends Component {
  ...
  render() {
    return (
        <section>
        <h1 class="hr"><img src="https://img.icons8.com/cotton/64/000000/lighthouse--v5.png"/></h1>
        ...
        <h1 class="hr">                <img src="https://img.icons8.com/cotton/64/000000/sneakers--v3.png"/><img src="https://img.icons8.com/cotton/64/000000/sneakers--v2.png"/></h1>
