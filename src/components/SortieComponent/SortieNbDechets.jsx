...
import { AddEvenement } from '../../actions/evenements';

class SortieNbDechets extends React.Component {
  handleAdd = () => {
    const evenement = {
      title: this.title,
...
export default connect(mapStateToProps, mapDispatchToProps)(SortieNbDechets);
