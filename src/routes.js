...
const Connexion = React.lazy(() =>
  import('./components/PagesComponents/Connexion/Connexion')
);
const Formulaire = React.lazy(() =>
  import('./components/PagesComponents/UtilisateurCreation/Formulaire')
);
const ListeUtilisateur = React.lazy(() =>
  import('./components/PagesComponents/UtilisateurCreation/ListUser')
);
const UserUpdate = React.lazy(() =>
  import('./components/PagesComponents/UtilisateurCreation/UserUpdate')
);
const ProfilUser = React.lazy(() =>
  import('./components/PagesComponents/UtilisateurCreation/ProfilUser')
);

const SuggestionCreation = React.lazy(() =>
  import('./components/PagesComponents/Suggestion/SuggestionCreation')
);
const SuggestionListe = React.lazy(() =>
  import('./components/PagesComponents/Suggestion/SuggestionList')
);
...
const SortieOrganisation = React.lazy(() =>
  import('./components/SortieComponent/SortieOrganisation')
);
const SortieSuscribedList = React.lazy(() =>
  import('./components/SortieComponent/SortieSuscribedList')
);

const TodoCreation = React.lazy(() =>
  import('./components/PagesComponents/Todo/TodoComponent')
);
const TodoListComponent = React.lazy(() =>
  import('./components/PagesComponents/Todo/TodoListComponent')
);

const EvenementCreation = React.lazy(() =>
  import('./components/PagesComponents/Evenement/EvenementCreation')
);
const EvenementList = React.lazy(() =>
  import('./components/PagesComponents/Evenement/EvenementList')
);
const NextEvenement = React.lazy(() =>
...
const MessageListe = React.lazy(() =>
  import('./components/PagesComponents/ForumComponent/MessageComponent/MessageListe')
);

const ThreadCreation = React.lazy(() =>
  import('./components/PagesComponents/ForumComponent/ThreadComponent/ThreadCreation')
);
const ThreadList = React.lazy(() =>
  import('./components/PagesComponents/ForumComponent/ThreadComponent/ThreadList')
);
...
const routes = [
  ...
  {
    path: '/SuggestionCreation',
    name: 'SuggestionCreation',
  ...
  {
    path: '/SortieOrganisation',
    name: 'SortieOrganisation',
    component: SortieOrganisation,
  },
  {
    path: '/SortieSuscribedList',
    name: 'SortieSuscribedList',
    component: SortieSuscribedList,
  },
